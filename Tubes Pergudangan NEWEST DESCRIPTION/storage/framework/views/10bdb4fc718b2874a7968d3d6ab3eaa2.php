    ...
    <div class="auth-wrapper">
        <div class="card auth-card p-4">
            <div class="card-body">
                ...
                <p class="mt-4 text-center text-muted">Sudah punya akun? <a href="<?php echo e(route('login')); ?>" class="fw-bold">Login di sini</a></p>
            </div>
        </div>
    </div>
</body>
</html>
<?php /**PATH C:\Users\egiag\Downloads\Tubes Pergudangan\Tubes Pergudangan\resources\views/auth/register.blade.php ENDPATH**/ ?>